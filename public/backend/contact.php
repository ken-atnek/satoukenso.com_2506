...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
	...
	// **ヘッダー作成**
	$header_from = 'From: "' . mb_encode_mimeheader($name, 'ISO-2022-JP') . '" <no-reply@satoukenso.com>' . "\r\n";
	...
	// **送信**
	$rslt = mb_send_mail($send_target, $subject, $mail_body, $header_from, "-fno-reply@satoukenso.com");
	// **エンコーディングを元に戻す**
